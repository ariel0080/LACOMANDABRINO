...
/* harmony import */ var _pipes_filtrar_productos_pipe__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./pipes/filtrar-productos.pipe */ "./src/app/pipes/filtrar-productos.pipe.ts");
...
let WorkOrderComponent = class WorkOrderComponent {
    ...
    ReadyToServe(item) {
        ...
        this.order = Object.assign(new src_app_models_order__WEBPACK_IMPORTED_MODULE_2__["Order"](), this.order);
        this.order.UpdateOrderState();
        let mensaje = `El usuario ${this.me.email} (${this.me.role}) comenzó a preparar ${item.name} del pedido ${this.order.codeID}`;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FiltrarProductosPipe", function() { return FiltrarProductosPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let FiltrarProductosPipe = class FiltrarProductosPipe {
    transform(arreglo, empleado) {
        const arregloTmp = new Array();
...
FiltrarProductosPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! C:\Users\Ariel\Desktop\LC\LACOMANDABRINO\src\main.ts */"./src/main.ts");
