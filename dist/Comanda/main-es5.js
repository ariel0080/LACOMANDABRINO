...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OrderListComponent = /** @class */ (function () {
                ...
                OrderListComponent.prototype.mozoCancelar = function (order) {
                    order.state = src_app_models_order__WEBPACK_IMPORTED_MODULE_2__["OrderState"].cancelled;
                    this.orderService.Update(order);
                };
                OrderListComponent.prototype.mozoAprueba = function (order) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WorkOrderComponent = /** @class */ (function () {
                ...
                WorkOrderComponent.prototype.filtrarPorRol = function () {
                    var _this = this;
                    var resultado = new Array();
                    this.order.items.forEach(function (element) {
                        if (JSON.stringify(element.cook) === JSON.stringify(_this.me.role)) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchOrderComponent = /** @class */ (function () {
                ...
                SearchOrderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.au.GetCurrentUser().then(function (escliente) { _this.usuarioAux = escliente; });
                ...
                SearchOrderComponent.prototype.FindOrder = function () {
                    ...
                    this.orderService
                        ...
                        console.log(ord.state !== "Cancelado" &&
                            ((ord.client === _this.usuarioAux && src_app_models_user__WEBPACK_IMPORTED_MODULE_12__["Role"].cliente === _this.usuarioAux.role) ||
                                _this.usuarioAux.role === src_app_models_user__WEBPACK_IMPORTED_MODULE_12__["Role"].mozo));
                        ...
                        if (ord.state !== "Cancelado" &&
                            ((ord.client.id === _this.usuarioAux.id && src_app_models_user__WEBPACK_IMPORTED_MODULE_12__["Role"].cliente === _this.usuarioAux.role) ||
                                _this.usuarioAux.role === src_app_models_user__WEBPACK_IMPORTED_MODULE_12__["Role"].mozo)) {
                            _this.order = ord;
                        }
                    })
            ...
            var EstadisticasMesasComponent = /** @class */ (function () {
                ...
                EstadisticasMesasComponent.prototype.getTops = function () {
                    ...
                    copia.subscribe(function (orders) {
                        ...
                        _this.mesaMasUsada = result[cantidad - 1];
                        _this.mesaMenosUsada = result[0];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OrderService = /** @class */ (function () {
                ...
                OrderService.prototype.GetByCodeUser = function (code) {
                    var documents = this.db.collection("pedidos", function (ref) { return ref.where("client.email", "==", code) &&
